...
const ROLE_PERMISSIONS = {
  admin: { bn_open_details: true, can_view_ticket: true, can_view_paid: true, can_view_special: true, can_view_bags: true, can_view_docs: true, can_view_outbound: true, can_view_inbound: true },
  manager: { bn_open_details: true, can_view_ticket: true, can_view_paid: true, can_view_special: true, can_view_bags: true, can_view_docs: true, can_view_outbound: true, can_view_inbound: true },
  agent: { bn_open_details: true, can_view_ticket: true, can_view_paid: true, can_view_special: true, can_view_bags: true, can_view_docs: false, can_view_outbound: true, can_view_inbound: true },
  lounge: { bn_open_details: false, can_view_ticket: true, can_view_paid: false, can_view_special: false, can_view_bags: false, can_view_docs: false, can_view_outbound: false, can_view_inbound: false }
};
